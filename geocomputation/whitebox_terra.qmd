...
![](images/whitebox_terra_10.png)

```{r}

library(patchwork)

g11 <- wrap_plots(g8, g9, g10, g5) +
  plot_layout(
    ncol = 2,
    nrow = 2
  ) +
  plot_annotation(
    ...
    subtitle = "Comparing the performance of {terra} generated shaded maps, vs. the {whitebox} generated maps.",
    caption = plot_caption,
    tag_levels = "I",
    theme = theme(
      plot.title = element_text(
