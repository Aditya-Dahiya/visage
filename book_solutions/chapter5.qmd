...
The longest border is of Texas (4,959.8 km) and the shortest border is of District of Columbia (60.2 km). The complete list is at @tbl-e6 .

```{r}
#| label: tbl-e6
#| tbl-cap: "The border length of the different states in USA"
#| eval: true
#| code-fold: true
...
The different methods of resampling rasters and their demonstration is in @fig-e7-a
...
![The various methods of resampling in the {terra} for rasters.](images/chapter5-e7.png){#fig-e7-a}

Another method for converting into the resolution of (0.01, 0.01) is to use `terra::aggregate()` with `fact = 0.01 / 0.00083`.

```{r}
#| label: fig-e8
#| fig-cap: "Using terra::aggregate() to make resolution of 0.01"
#| fig-width: 4
#| eval: true
#| code-fold: true
