...
geoportals <- tibble::tibble(
  ...
  Description = c(
    "Provides a wide range of geospatial datasets, often location-specific.",
    "Global coverage of raster datasets, suitable for a variety of analyses.",
    "Offers global raster datasets and APIs for data analysis.",
    "NASA-managed portal for vector datasets with global and regional coverage.",
    "European Union's geoportal for datasets with regional and global focus.",
    "USGS portal offering interactive dataset exploration with spatial/temporal filtering."
  ),
  Link = c(
